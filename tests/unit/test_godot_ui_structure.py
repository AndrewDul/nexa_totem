...
class GodotUiStructureTests(unittest.TestCase):
    ...
    def test_reminders_screen_and_notifications_are_represented(self):
        ...
        self.assertIn("_handle_due_reminder_modal_tap(position)", tap_func)
        self.assertLess(tap_func.find("_handle_due_reminder_modal_tap(position)"), tap_func.find("text_input_open"))
